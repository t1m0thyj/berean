#!/usr/bin/env python
"""wycliffe.py - downloads Wycliffe from Wikisource and converts it to USFM
Author: Chris Little (Sword Project)
http://www.crosswire.org/pipermail/sword-devel/2014-March/041177.html
