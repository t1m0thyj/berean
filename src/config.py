...
VERSION_NAMES = (
    ...
    "RV", "SpaRV", "SpaSEV", "Tyndale", "WEB", "WEBBE", "WEBME", "Webster",
    "Weymouth", "Wycliffe", "YLT",
    )
...
CHAPTER_LENGTHS = (
    ...
    (11, 23, 5, 19, 15, 11, 16, 14, 17, 15, 12, 14, 16, 9), (20, 32, 21),
    (15, 16, 15, 13, 27, 14, 17, 14, 15), (21,), (17, 10, 10, 11),
    (16, 13, 12, 13, 15, 16, 20), (15, 13, 19), (17, 20, 19), (18, 15, 20),
    (15, 23), (21, 13, 10, 14, 11, 15, 14, 23, 17, 12, 17, 14, 9, 21),
    (14, 17, 18, 6),
    ...
    (24, 21, 29, 31, 26, 18), (23, 22, 21, 32, 33, 24), (30, 30, 21, 23),
    (29, 23, 25, 18), (10, 20, 13, 18, 28), (12, 17, 18),
    (20, 15, 16, 16, 25, 21), (18, 26, 17, 22), (16, 15, 15), (25,),
    (14, 18, 19, 16, 14, 20, 28, 13, 28, 39, 40, 29, 25), (27, 26, 18, 17, 20),
    (25, 25, 22, 19, 14), (21, 22, 18), (10, 29, 24, 21, 21), (13,), (14,),
    (25,),
...
FLAG_NAMES = dict(zip(VERSION_NAMES, (
    "us", "gb", "gb", "nl", "fr", "de", "us", "gb", "gb", "es", "es", "gb",
    "us", "gb", "us", "us", "gb", "gb", "scotland",
    )))

BOOK_RANGES = (
    (1, 66), (1, 39), (1, 5), (6, 17), (18, 22), (23, 27), (28, 39), (40, 66),
    (40, 44), (45, 58), (59, 65), (66, 66),
    )

FONT_SIZES = [str(i) for i in (
